            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto navbar-list">
                <li class="nav-item">
                  <a class="search-toggle iq-waves-effect language-title" href="#"
                    ><span
                      ...
                      style="width: 98px; height: 98px; top: -15px; left: 56.2969px"
                    ></span
                    ><img
                    ...
                    EN <i class="ri-arrow-down-s-line"></i
                  ></a>
                ...
                <li class="nav-item nav-icon">
                  <a href="#" class="iq-waves-effect bg-primary rounded"
                  ...
                  <div class="iq-sub-dropdown">
                    <div class="iq-card shadow-none m-0">
                      <div class="iq-card-body p-0">
                        <div class="bg-primary p-3">
                          <h5 class="mb-0 text-white">
                            All Messages<small class="badge badge-light float-right pt-1"
                              >5</small
                            >
                          </h5>
                        </div>
