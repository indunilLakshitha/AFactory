                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li>
                        ...
                        <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                           <li><Link :href="route('admin.user.profile')"><i class="las la-id-card-alt"></i>User Profile</Link></li>
                           ...
                           <li><Link :href="route('admin.user.list')"><i class="las la-th-list"></i>User List</Link></li>
                        </ul>
                     </li>
