        ...
        <div class="row">
              ...
              <div class="iq-card-body iq-box-relative">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <span class="text-primary"
                    ><b> +14% <i class="ri-arrow-up-fill"></i></b
                  ></span>
                </div>
              </div>
            </div>
              ...
              <div class="iq-card-body iq-box-relative">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <span class="text-danger"
                    ><b> -6% <i class="ri-arrow-down-fill"></i></b
                  ></span>
                </div>
              </div>
            </div>
              ...
              <div class="iq-card-body iq-box-relative">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <span class="text-success"
                    ><b> +0.36% <i class="ri-arrow-up-fill"></i></b
                  ></span>
                </div>
              </div>
            </div>
              ...
              <div class="iq-card-body iq-box-relative">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <span class="text-warning"
                    ><b> +0.45% <i class="ri-arrow-up-fill"></i></b
                  ></span>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div
              ...
              style="
                background: transparent url(images/page-img/45.png) no-repeat scroll
                  center bottom;
